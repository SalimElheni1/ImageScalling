...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	IplImage* img = cvLoadImage("E:\\these_doctorat_2014\\DVD_publication\\Papier-Fakhri-salim\\Images\\image1\\Image1-PNNquant2.png");
	...
	cvSaveImage(" test0_zo.bmp", images);
